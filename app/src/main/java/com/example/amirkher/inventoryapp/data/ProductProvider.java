...
/**
 * Created by Amirkher on 18.03.2018.
 */
...
public class ProductProvider extends ContentProvider{
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match){
            ...
            case PRODUCT_ID:
                ...
                // For an example URI such as "content://com.example.android.products/products/1",
                // the selection will be "_id=?" and the selection argument will be a
                // String array containing the actual ID of 1 in this case.
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        // Check that the in_stock status chosen
        Integer in_stock = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_INSTOCK);
        if (in_stock == null || !ProductEntry.isValidStatus(in_stock)) {
            throw new IllegalArgumentException("Product availability should be clear");
        }
        ...
        // Check that the supplier's title is not null
        String supplier = values.getAsString(ProductEntry.COLUMN_PRODUCT_SUPPLIER);
        if (supplier == null) {
            throw new IllegalArgumentException("Product requires a supplier title");
        }
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link ProductEntry#COLUMN_PRODUCT_INSTOCK} key is present,
        // check that the status value is valid.
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_INSTOCK)) {
            Integer status = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_INSTOCK);
